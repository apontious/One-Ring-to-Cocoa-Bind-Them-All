//
//  AppDelegate.m
//  Default Default Default Defaults, Default
...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
    [[NSUserDefaults standardUserDefaults] registerDefaults:@{@"DDDDDDownloadPodcastsAutomatically" : @YES,
                                                              @"DDDDDFavoritePodcast" : @"Edge Cases",
                                                              @"DDDDDDate" : [NSDate date]}];
}
